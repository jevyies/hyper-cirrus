...
export default {
    ...
    data() {
        return {
            ...
            items: [
                ...
                {
                    text: "Delivery Unit",
                    href: `/administration/delivery-unit/`,
                },
                {
                    text: "Department",
                    active: true,
            ...
            form: {
                ...
                departmentName: "",
                shortName: "",
                deliveryUnitId: this.$route.params.id,
            },
            indexSelected: -1,
            tableBusy: false,
        };
    ...
    created() {
        ...
        this.tableBusy = true;
        this.$store
            .dispatch("deliveryunit/GetSingleDeliveryUnit", this.$route.params.id)
            .then((res) => {
                this.title = res.data.shortName + " Departments";
                this.items[2].href += res.data.office.campus.agencyId;
                this.items[3].href += res.data.office.campusId;
                this.items[4].href += res.data.officeId;
            })
            .catch(() => {
                this.showToast('Something went wrong!', 'error');
            });
        this.$store
            .dispatch("department/GetDepartmentByDU", this.$route.params.id)
            .then((res) => {
    ...
    methods: {
        ...
        deleteItem(props) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    this.$store
                        .dispatch("department/DeleteDepartment", props.item.id)
                        .then((res) => {
                            if (res.status == 204) {
