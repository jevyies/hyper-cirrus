...
export default {
  ...
  methods: {
    ...
    createProperty(props) {
      ...
      console.log(this.pendingData[iarIndex]);
      this.form.poNumber = this.pendingData[iarIndex].po.poNumber;
      this.form.supplierId = this.pendingData[iarIndex].po.rfqSupplier.supplierId;
      this.form.supplier = this.pendingData[iarIndex].po.rfqSupplier.supplier.name;
    ...
    >
      <form @submit.prevent="onPost" class="needs-validation mt-3" ref="fcForm">
        ...
        <div class="d-flex justify-content-between">
          <h5 class="mt-3">Page {{ currentPageQuantity }} of {{ form.quantity }}</h5>
                        ...
                        <table width="100%">
                          <thead>
                            <tr class="border-bottom">
                              ...
                              <th class="py-2" style="width: 65px">Actions</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr
