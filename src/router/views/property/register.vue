  ...
  created() {
    ...
    this.$store
      ...
      .then((res) => {
        ...
        // this.tableData = this.onGroup(res.data);
      })
      .catch(() => {
        this.tableBusy = false;
    ...
    onCreate() {
      ...
      if (this.$v.$invalid) {
        ...
        if (this.form.id > 0) {
          ...
          this.form.dateAcquired = this.setDate(this.form.dateAcquired);
          this.$store
            .dispatch("property/CreateProperty", this.form)
            .then((res) => {
              if (res.data.error) {
                return this.showToast(res.data.detail, "error");
              }
            ...
            .catch((err) => {
              this.showToast(
                "Something went wrong creating property!",
                "error"
              );
            });
        }
                ...
                <div class="row mb-3">
                  <div class="col-md-6">
                    <div class="d-flex align-items-center h-100">
                      <h5 class="mt-0">List of Pending Properties</h5>
                    </div>
                  </div>
                  <div class="col-md-6">
                        ...
                        >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        >
                                        <b-dropdown-item
                                          @click="deleteItem(propertyRow.item)"
                                          variant="danger"
                                          ><i
                                            class="
                                              mdi mdi-trash-can
                          ...
                          <!-- <div>
                            <b-card
                              no-body
                              class="mb-3"
                              v-for="(x, index) in row.item.details"
                              :key="x.id"
                              :style="{
                                'z-index': row.item.details.length - index,
                              }"
                            >
                              <b-card-header
                                header-tag="header"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <b-dropdown-item @click="updateItem(x)"
                                        ><i
                                          class="
                                            mdi mdi-update
                                            font-size-18
                              ...
                              <b-collapse :visible="x.visible" role="tabpanel">
                                <b-card-body class="border">
                                  <div
                                    class="
                                      d-flex
                                      ...
                                      cursor-pointer
                                    "
                                    @click="x.itemVisible = !x.itemVisible"
                                  >
                                    <h6 class="mb-0">
                                      <i class="bx bx-menu-alt-right"></i>
                                      Property Details
                                      ...
                                      <b-col sm="6">
                                        ...
                                        <b-row class="mb-2">
                                          <b-col sm="4" class="text-right">
                                            <b>Property Number:</b></b-col
                                          >
                                          <b-col>{{ x.propertyNumber }}</b-col>
                                        </b-row>
                                        <b-row class="mb-2">
                                          <b-col sm="4" class="text-right">
                                            <b>Serial Number:</b></b-col
                                          >
                                          <b-col>{{ x.serialNumber }}</b-col>
                                        </b-row>
                                        <b-row class="mb-2">
                                          <b-col sm="4" class="text-right"
                                            ><b>Date Acquired:</b></b-col
                                          >
                                          <b-col>{{
                                            formatDate(new Date(x.dateAcquired))
                                          }}</b-col>
                                        </b-row>
                                        <b-row class="mb-2">
                                          <b-col sm="4" class="text-right">
                                      ...
                                      >
                                        ...
                                        <b-row class="mb-2">
                                          <b-col sm="4" class="text-right">
                                            <b>Supplier:</b></b-col
                                          >
                                          <b-col>{{ x.supplier }}</b-col>
                                        </b-row>
                                        <b-row class="mb-2">
                                          <b-col sm="4" class="text-right"
                                            ><b>PO Number:</b></b-col
                                          >
                                          <b-col>{{ x.poNumber }}</b-col>
                                        </b-row>
                                        <b-row class="mb-2">
                                          <b-col sm="4" class="text-right">
                                            <b>Notes:</b></b-col
