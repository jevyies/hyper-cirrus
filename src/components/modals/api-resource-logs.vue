...
export default {
    ...
    methods: {
        ...
        hideModal() {
            this.$bvModal.hide("api-resoure-log-modal");
        },
        getData(id) {
            this.tableBusy = true;
            this.$store
                .dispatch("apiresourecelog/GetApiResourceLogs", id)
                .then((res) => {
...
<template>
    <b-modal
        id="api-resoure-log-modal"
        title="API Resource Logs"
        size="xl"
        title-class="font-18"
        hide-footer
