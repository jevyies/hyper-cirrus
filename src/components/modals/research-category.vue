...
export default {
    ...
    methods: {
        ...
        addRc() {
            this.onReset();
            this.modalTitle = "Create New Research Category";
            this.$bvModal.show("rc-modal");
        },
        onReset() {
            this.form = {
                id: 0,
        ...
        onCreate() {
            ...
            if (this.$v.$invalid) {
                ...
                if (this.form.id > 0) {
                    this.$store
                        .dispatch("researchcategory/UpdateResearchCategory", this.form)
                        .then((res) => {
                    ...
                    this.$store
                        .dispatch("researchcategory/CreateResearchCategory", this.form)
                        .then((res) => {
        ...
        updateItem(props) {
            ...
            this.modalTitle = "Update Research Category";
            this.$bvModal.show("rc-modal");
        },
        deleteItem(props) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    this.$store
                        .dispatch("researchcategory/DeleteResearchCategory", props.item.id)
                        .then((res) => {
                            if (res.status == 204) {
        ...
        dropData(data) {
            ...
            this.$bvModal.hide("research-category-modal");
        },
    },
    created() {
        this.tableBusy = true;
...
<template>
    <b-modal
        id="research-category-modal"
        title="Research Category List"
        size="lg"
        title-class="font-18"
        hide-footer
