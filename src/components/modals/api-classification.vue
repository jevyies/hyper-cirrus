...
export default {
    ...
    methods: {
        ...
        onCreate() {
            ...
            if (this.$v.$invalid) {
                ...
                if (this.form.id > 0) {
                    this.$store
                        .dispatch("indicatoritemclassification/UpdateApiClassification", this.form)
                        .then((res) => {
                    ...
                    this.$store
                        .dispatch("indicatoritemclassification/CreateApiClassification", this.form)
                        .then((res) => {
        ...
        deleteItem(props) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    this.$store
                        .dispatch("indicatoritemclassification/DeleteIndicatorItemClassification", props.item.id)
                        .then((res) => {
                            if (res.status == 204) {
    ...
    created() {
        this.tableBusy = true;
        this.$store
            .dispatch("indicatoritemclassification/GetIndicatorItemClassification")
            .then((res) => {
...
<template>
    <b-modal
        id="api-classification-modal"
        title="Indicator Item Classification List"
        size="lg"
        title-class="font-18"
        hide-footer
                    ...
                    >
                        ...
                        >
                            <div class="mb-3">
                                ...
                                >
                                    <span
                                        v-if="!$v.form.classification.required"
