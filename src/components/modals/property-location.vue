          ...
          >
            <div>
              <b-alert
                ...
                variant="success"
              >
                <i class="mdi mdi-check-all me-2"></i>{{ alertForm.message }}
              </b-alert>
              <b-alert
                ...
                variant="danger"
              >
                <i class="mdi mdi-block-helper me-2"></i>{{ alertForm.message }}
              </b-alert>
              <b-alert
            ...
            >
              ...
              <div class="mb-3">
                ...
                <input
                  ...
                  class="form-control"
                  :class="{
                    'is-invalid': submitted && $v.form.locationCode.$error,
                  }"
                />
                <div
