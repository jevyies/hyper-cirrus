...
export default {
    ...
    methods: {
        ...
        addJc() {
            this.onReset();
            this.modalTitle = "Create New Job Category";
            this.$bvModal.show("jc-modal");
        },
        onReset() {
            this.form = {
                id: 0,
        ...
        onCreate() {
            ...
            if (this.$v.$invalid) {
                ...
                if (this.form.id > 0) {
                    this.$store
                        .dispatch("jobcategory/UpdateJobCategory", this.form)
                        .then((res) => {
                    ...
                    this.$store
                        .dispatch("jobcategory/CreateJobCategory", this.form)
                        .then((res) => {
        ...
        updateItem(props) {
            ...
            this.modalTitle = "Update Job Category";
            this.$bvModal.show("jc-modal");
        },
        deleteItem(props) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    await this.$store
                        .dispatch("jobcategory/DeleteJobCategory", props.item.id)
                        .then((res) => {
                            if (res.status == 204) {
        ...
        getNotTracked(){
            return this.tableData.find(x => x.category === "Not Tracked")
        }
    },
    created() {
        this.tableBusy = true;
        this.$store
            .dispatch("jobcategory/GetJobCategory")
            .then((res) => {
