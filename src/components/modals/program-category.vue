...
export default {
    ...
    methods: {
        ...
        addPc() {
            this.onReset();
            this.modalTitle = "Create New Program Category";
            this.$bvModal.show("pc-modal");
        },
        onReset() {
            this.form = {
                id: 0,
        ...
        onCreate() {
            ...
            if (this.$v.$invalid) {
                ...
                if (this.form.id > 0) {
                    this.$store
                        .dispatch("programcategory/UpdateProgramCategory", this.form)
                        .then((res) => {
                    ...
                    this.$store
                        .dispatch("programcategory/CreateProgramCategory", this.form)
                        .then((res) => {
        ...
        updateItem(props) {
            ...
            this.modalTitle = "Update Program Category";
            this.$bvModal.show("pc-modal");
        },
        deleteItem(props) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    this.$store
                        .dispatch("programcategory/DeleteProgramCategory", props.item.id)
                        .then((res) => {
                            if (res.status == 204) {
        ...
        dropData(data) {
            ...
            this.$bvModal.hide("program-category-modal");
        },
    },
    created() {
        this.tableBusy = true;
