...
export default {
    ...
    methods: {
        ...
        addPc() {
            this.onReset();
            this.modalTitle = "Create New Product Category";
            this.$bvModal.show("prc-modal");
        },
        onReset() {
            this.form = {
                id: 0,
        ...
        onCreate() {
            ...
            if (this.$v.$invalid) {
                ...
                if (this.form.id > 0) {
                    this.$store
                        .dispatch("productcategory/UpdateProductCategory", this.form)
                        .then((res) => {
                    ...
                    this.$store
                        .dispatch("productcategory/CreateProductCategory", this.form)
                        .then((res) => {
        ...
        deleteItem(props) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    this.$store
                        .dispatch("productcategory/DeleteProductCategory", props.item.id)
                        .then((res) => {
                            if (res.status == 204) {
        ...
        dropData(data) {
            ...
            this.$bvModal.hide("product-category-modal");
        },
    },
    created() {
        this.tableBusy = true;
        this.$store
            .dispatch("productcategory/GetProductCategory")
            .then((res) => {
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    :class="{
                                        'is-invalid':
                                            submitted &&
                                            $v.form.categoryName.$error,
                                    }"
                                />
                                <div
                                    v-if="
                                        submitted && $v.form.categoryName.$error
                                    "
                                    class="invalid-feedback"
                                >
                                    <span v-if="!$v.form.categoryName.required"
