...
export default {
    ...
    methods: {
        ...
        addAccreditor() {
            this.onReset();
            this.modalTitle = "Create New Accreditor";
            this.$bvModal.show("acc-modal");
        },
        onReset() {
            this.form = {
                id: 0,
        ...
        onCreate() {
            ...
            if (this.$v.$invalid) {
                ...
                if (this.form.id > 0) {
                    this.$store
                        .dispatch("accreditor/UpdateAccreditor", this.form)
                        .then((res) => {
                    ...
                    this.$store
                        .dispatch("accreditor/CreateAccreditor", this.form)
                        .then((res) => {
        ...
        updateItem(props) {
            ...
            this.modalTitle = "Update Accreditor";
            this.$bvModal.show("acc-modal");
        },
        deleteItem(props) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    this.$store
                        .dispatch("accreditor/DeleteAccreditor", props.item.id)
                        .then((res) => {
                            if (res.status == 204) {
        ...
        dropData(data) {
            ...
            this.$bvModal.hide("accreditor-modal");
        },
        getData() {
            this.tableBusy = true;
            this.$store
                .dispatch("accreditor/GetAccreditor")
                .then((res) => {
                        ...
                        >
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    id="accreditorName"
                                    type="text"
                                    v-model="form.accreditorName"
                                    placeholder="Enter Accreditor Name..."
                                    class="form-control"
                                    :class="{
                                        'is-invalid':
                                            submitted &&
                                            $v.form.accreditorName.$error,
                                    }"
                                />
                                <div
                                    v-if="
                                ...
                                >
                                    <span
                                        v-if="!$v.form.accreditorName.required"
